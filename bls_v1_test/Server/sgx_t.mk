...
Enclave_Link_Flags := $(SGX_COMMON_CFLAGS) -Wl,--no-undefined -nostdlib -nodefaultlibs -nostartfiles \
	...
	-Wl,--start-group -L/opt/gmp/6.1.2/lib/ -lsgx_tgmp -L/usr/local/lib64/ -lsgx_tpbc -lsgx_tstdc -lsgx_pthread -lsgx_tcxx -lsgx_tcrypto $(TSETJMP_LIB) -l$(Service_Library_Name) -Wl,--end-group \
